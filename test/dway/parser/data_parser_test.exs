defmodule Dway.Parser.DataParserTest do
  ...
  describe "parse_order_params/1" do
    ...
    assert {:ok, %Dway.Fleet.Order{customer_name: "Theodora", delivery_coordinates: %{lat: -22.52219686435724, long: -44.10977748780379}, id: "95436212", pickup_coordinates: %{lat: -22.50776369362348, long: -44.09077352792969}, time_window: 1.8e3}} = response
